...
from cli import LogStats, LogLine
...
class TestLogStats:
    ...
    def test_stats_add_multiple_levels(self):
        ...
        lines = [
            ...
            LogLine("test.log", "ERROR msg", datetime(2025, 11, 20, 17, 45, 33), "ERROR"),
    ...
    def test_stats_comprehensive(self):
        ...
        lines = [
            LogLine("test.log", "DEBUG msg", datetime(2025, 11, 20, 10, 15, 30), "DEBUG"),
            ...
            LogLine("test.log", "ERROR msg", datetime(2025, 11, 20, 12, 15, 30), "ERROR"),
            LogLine("test.log", "CRITICAL msg", datetime(2025, 11, 20, 12, 30, 30), "CRITICAL"),
