...
from cli import parse_timestamp, detect_level, iter_log_lines, DEFAULT_DATE_FORMAT
...
class TestIterLogLines:
    ...
    def test_iter_log_lines_custom_date_format(self, tmp_path, log_lines_with_custom_format, custom_date_format):
